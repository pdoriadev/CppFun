...
private:
	...
	std::vector<SpellCategories::type> categories = {SpellCategories::type::UNASSIGNED};
	bool wizardOnly = false;

public:
	spell(std::string _name, std::string _desc, Schools::type _school, 
		int _roll, std::vector<SpellCategories::type> _categories,  bool _wizardOnly)
	{
		...
		assert(_categories[0] != SpellCategories::type::UNASSIGNED && "Category is unassigned");
	...
	std::vector<SpellCategories::type> * getCategories() { return &categories; }
};
