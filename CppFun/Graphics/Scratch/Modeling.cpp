...
bool vector3::scale_uniform(float s, vector3& outVec)
{
    outVec.set_x(s * outVec.x());
    outVec.set_y(s * outVec.y());
    outVec.set_z(s * outVec.z());
    return true;
}

bool vector3::modulo(int m, vector3& outVec)
{
