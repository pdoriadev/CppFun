...
*******************************************************************************/
std::size_t CSUF::CPSC131::Student::nextAvailableID = 2021'02'01;    // The single quote is a digit separator used only for human readability and is ignored by the compiler
